\hypertarget{group__flac__metadata}{}\doxysection{F\+L\+A\+C/metadata.h\+: metadata interfaces}
...
\begin{DoxyCompactList}\small\item\em The level 0 interface consists of individual routines to read the S\+T\+R\+E\+A\+M\+I\+N\+FO, V\+O\+R\+B\+I\+S\+\_\+\+C\+O\+M\+M\+E\+NT, C\+U\+E\+S\+H\+E\+ET, and P\+I\+C\+T\+U\+RE blocks, requiring only a filename. \end{DoxyCompactList}\end{DoxyCompactItemize}
