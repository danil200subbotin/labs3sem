...
{
    long l = 10000000000;
    ASSERT_NO_THROW(laba3bit1::Biglong a(l));
}

TEST (BLConstructors, ErrbyNotNum)
{
    ASSERT_NO_THROW(laba3bit1::Biglong a("char23"));
}

TEST (BLConstructors, ErrRandomMinus)
{
    ASSERT_NO_THROW(laba3bit1::Biglong a("132-213"));
}
...
TEST (BLSetters, multi10minus)
{
    laba3bit1::Biglong a(-213213);
    a.multi10();
    ASSERT_EQ( 2 + '0', a.get_one_char(a.get_max_length() - a.get_length()));
}
